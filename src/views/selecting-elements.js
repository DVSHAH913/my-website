...
const SelectingElements = (props) => {
  return (
    <div className="selecting-elements-container1">
      ...
      <div className="selecting-elements-container2">
        <Heading
        ...
        <div className="selecting-elements-container3"></div>
      </div>
      <div className="selecting-elements-container4">
        <h2 className="selecting-elements-text1 Subheading">Give it a try</h2>
        <span className="selecting-elements-text2">
        ...
        <div className="selecting-elements-container5">
          ...
          <span className="selecting-elements-text5">Text</span>
        </div>
      </div>
      <h1 className="selecting-elements-text6">Select me as well</h1>
      <div className="selecting-elements-container6">
        ...
        <img
          ...
          className="selecting-elements-image3"
        />
      </div>
      <span className="selecting-elements-text7">
        And you can also select me
      </span>
      <div className="selecting-elements-container7">
