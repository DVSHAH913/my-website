    ...
    <div className="building-layouts-card-alignment-container1">
      ...
      <div className="building-layouts-card-alignment-container2">
        <div className="building-layouts-card-alignment-container3">
          ...
          ></Heading>
          <h2 className="building-layouts-card-alignment-text1 Subheading">
            Desired Outcome
          </h2>
          <div className="building-layouts-card-alignment-container4">
            <h1 className="building-layouts-card-alignment-text2">Heading</h1>
            <span className="building-layouts-card-alignment-text3">
          ...
          <h2 className="building-layouts-card-alignment-text4 Subheading">
            Give it a try
          </h2>
          ...
          <div className="building-layouts-card-alignment-feedback">
            <span>
              ...
              <a href="mailto:hello@teleporthq.io?subject=">
                <span className="building-layouts-card-alignment-text7">
                  hello@teleporthq.io
                </span>
              </a>
              <span className="building-layouts-card-alignment-text8"></span>
              <span>
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
