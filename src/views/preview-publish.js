        ...
        <div className="preview-publish-container3">
          ...
          <div className="preview-publish-container4">
            <div className="preview-publish-container5">
              <h2 className="preview-publish-text1 Subheading">Preview</h2>
                ...
                <div className="preview-publish-container6">
                  ...
                  <div className="preview-publish-container7">
                    <svg
                      ...
                      className="preview-publish-icon1"
                    >
          ...
          <h2 className="preview-publish-text2 Subheading">Publish</h2>
          <div className="preview-publish-ul2">
            <div className="preview-publish-container8">
              ...
              <div className="preview-publish-container9">
                <svg viewBox="0 0 1024 1024" className="preview-publish-icon3">
