    ...
    <div className="styling-elements-container1">
      ...
      <div className="styling-elements-container2">
        <div className="styling-elements-container3">
          ...
          ></Heading>
          <h2 className="styling-elements-text1 Subheading">Desired Outcome</h2>
            ...
            <div className="styling-elements-container7">
              ...
              <div className="styling-elements-container8">
                <svg
                  ...
                  className="styling-elements-icon1"
                >
          ...
          <h2 className="styling-elements-text4 Subheading">Try it yourself</h2>
          <div className="styling-elements-container9">
            <img
              alt="image"
        ...
        <h2 className="styling-elements-text7 Subheading">
          <span>Bonus - C</span>
