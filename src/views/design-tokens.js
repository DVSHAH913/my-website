    ...
    <div className="design-tokens-container1">
      ...
      <div className="design-tokens-container2">
        <div className="design-tokens-container3">
          ...
          <div className="design-tokens-ul">
            ...
            <div className="design-tokens-container4">
              ...
              <div className="design-tokens-container5">
                <svg viewBox="0 0 1024 1024" className="design-tokens-icon1">
          ...
          <h2 className="design-tokens-text1 Subheading">Desired Outcome</h2>
          <div className="design-tokens-container6">
            <button className="design-tokens-button1 Button button">
              Button
            </button>
          </div>
          <h2 className="design-tokens-text2 Subheading">Give it a try</h2>
          <div className="design-tokens-container7">
